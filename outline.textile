...
For this problem SensorML profiles were established. They go further than just checking for validity by the given XML Schemas by adding schematron templates.
...
Can be validated against schematron file, useful for sensor operators/providers. 
