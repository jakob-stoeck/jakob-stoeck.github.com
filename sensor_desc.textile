h1. Literature review for standards in sensor descriptions

h2. Literature review for standards in sensor descriptions
...
bq. The ability to easily discover, access, and process sensors existing within different communities is very rare. SensorML provides a common framework for describing virtually any sensor system, as well as the processing that might be associated with these sensor systems. [SML]
...
h4. Example of a simple data value
...
h4. Example Template 25: Accelerometer and Force Transducers
